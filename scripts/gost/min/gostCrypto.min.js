...
a.keyMeshing&&(b.keyMeshing=a.keyMeshing),b.keyMeshing&&(b.keyMeshing=b.keyMeshing.toUpperCase()),"importKey"!==c&&"generateKey"!==c)){b.block=b.block||"ECB";b.padding=b.padding||("CBC"===b.block||"ECB"===b.block?"ZERO":"NO");if("CFB"===b.block||"OFB"===b.block)b.shiftBits=b.shiftBits||64;b.keyMeshing=b.keyMeshing||"NO"}"KW"===b.mode&&(a.keyWrapping&&(b.keyWrapping=a.keyWrapping),b.keyWrapping&&(b.keyWrapping=b.keyWrapping.toUpperCase()),"importKey"!==c&&"generateKey"!==c&&(b.keyWrapping=b.keyWrapping||
"NO"));"GOST 28147"===b.name&&1989===b.version?b.sBox=a.sBox||b.sBox||"E-A":"GOST 28147"===b.name&&2015===b.version?b.sBox="E-DEFAULT":"GOST R 34.11"===b.name&&1994===b.version?b.sBox=a.sBox||b.sBox||"D-A":"GOST R 34.10"===b.name&&1994===b.version?(b.sBox=a.sBox||b.sBox||"D-A",b.namedParam=a.namedParam||b.namedParam||("EC-DH"===b.mode?"X-A":"S-A")):"GOST R 34.10"===b.name&&2001===b.version?(b.sBox=a.sBox||b.sBox||"D-A",b.namedCurve=a.namedCurve||b.namedCurve||(256===b.length?"EC-DH"===b.mode?"X-256-A":
"S-256-A":"T-512-A"===b.mode)):"GOST R 34.10"===b.name&&2012===b.version&&(b.namedCurve=a.namedCurve||b.namedCurve||(256===b.length?"EC-DH"===b.mode?"X-256-A":"S-256-A":"T-512-A"===b.mode));switch(b.mode){case "DH":a.ukm&&(b.ukm=a.ukm);a["public"]&&(b["public"]=a["public"]);break;case "SIGN":case "KW":a.ukm&&(b.ukm=a.ukm);break;case "ES":case "MAC":a.iv&&(b.iv=a.iv);break;case "PBKDF2":a.salt&&(b.salt=a.salt);a.iterations&&(b.iterations=a.iterations);break;case "KDF":a.label&&(b.label=a.label),a.contex&&
(b.context=a.contex)}if(c&&("ES"!==b.mode&&"SIGN"!==b.mode&&"MAC"!==b.mode&&"HMAC"!==b.mode&&"KW"!==b.mode&&"generateKey"===c||"ES"!==b.mode&&("encrypt"===c||"decrypt"===c)||"SIGN"!==b.mode&&"MAC"!==b.mode&&"HMAC"!==b.mode&&("sign"===c||"verify"===c)||"HASH"!==b.mode&&"digest"===c||"KW"!==b.mode&&("wrapKey"===c||"unwrapKey"===c)||"DH"!==b.mode&&"PBKDF2"!==b.mode&&"KDF"!==b.mode&&("deriveKey"===c||"deriveBits"===c)))throw new p("Algorithm mode "+b.mode+" not valid for method "+c);a.hash&&(b.hash=a.hash);
b.hash&&(b.hash=h(b.hash,"digest"));a.id&&(b.id=a.id);return b}function l(a){return k&&k.subtle&&a&&(("string"===typeof a||a instanceof String)&&-1===a.toUpperCase().indexOf("GOST")||a.name&&-1===a.name.toUpperCase().indexOf("GOST")||a.hash&&a.hash.name&&-1===a.hash.name.toUpperCase().indexOf("GOST"))}function E(a,c){if(!a.algorithm)throw new u("Key algorithm not defined");if(!a.algorithm.name)throw new u("Key algorithm name not defined");var d=a.algorithm.name,e="GOST 28147"===d,b="GOST R 34.11"===
d,f="GOST R 34.10"===d;if(!e&&!f&&!b)throw new p("Key algorithm "+d+" is unsupproted");if(!a.type)throw new u("Key type not defined");if((e||b)&&"secret"!==a.type||f&&"public"!==a.type&&"private"!==a.type)throw new F("Key type "+a.type+" is not valid for algorithm "+d);if(!a.usages||!a.usages.indexOf)throw new u("Key usages not defined");d=0;for(e=a.usages.length;d<e;d++)if(b=a.usages[d],("wrapKey"===b||"unwrapKey"===b||"encrypt"===b||"decrypt"===b)&&"secret"!==a.type||"sign"===b&&"public"===a.type||
"verify"===b&&"private"===a.type)throw new H("Key type "+a.type+" is not valid for "+b);if(c&&-1===a.usages.indexOf(c))throw new G("Key usages is not contain method "+c);if(!a.buffer)throw new u("Key buffer is not defined");d=8*a.buffer.byteLength;if("secret"===a.type&&256!==d&&(0<=a.usages.indexOf("encrypt")||0<=a.usages.indexOf("decrypt"))||"private"===a.type&&256!==d&&512!==d||"public"===a.type&&512!==d&&1024!==d)throw new u("Key buffer has wrong size "+d+" bit");}function n(a,c,d){E(d,a);if(c){var e;
switch(c.mode){case "ES":e=["sBox","keyMeshing","padding","block"];break;case "SIGN":e=["namedCurve","namedParam","sBox"];break;case "MAC":e=["sBox"];break;case "KW":e=["keyWrapping","ukm"];break;case "DH":e=["namedCurve","namedParam","sBox","ukm"];break;case "PBKDF2":e=["sBox","iterations","salt"];break;case "KDF":e=["context","label"]}e&&e.forEach(function(a){d.algorithm[a]&&(c[a]=d.algorithm[a])})}return d.buffer}function x(a,c,d,e,b){a={type:b||"secret",extractable:c||"false",algorithm:a,usages:d||
[],buffer:e};E(a);return a}function I(a,c,d,e,b){if(!d||!d.indexOf)throw new u("Key usages not defined");var f=d.filter(function(a){return"sign"!==a});d=d.filter(function(a){return"verify"!==a});return{publicKey:x(a,c,f,e,"public"),privateKey:x(a,c,d,b,"private")}}function y(){for(var a=0,c=arguments.length;a<c;a++){var d=arguments[a].split("."),d=z+d[0]+A+"."+d[1],e=document.querySelector('script[src="'+d+'"]');e||(e=document.createElement("script"),e.setAttribute("src",d),document.head.appendChild(e))}}
function t(a,c,d){return new Promise(function(e,b){try{if(w){var D=++J;v.push({id:D,resolve:e,reject:b});w.postMessage({id:D,algorithm:a,method:c,args:d})}else f.gostEngine?e(f.gostEngine.execute(a,c,d)):b(new B("Module gostEngine not found"))}catch(m){b(m)}})}function r(a){try{a()}catch(c){}}function g(){}var f=this,k=f.crypto||f.msCrypto,u=f.SyntaxError||Error,F=f.DataError||Error,p=f.NotSupportedError||Error,B=f.OperationError||Error,H=f.InvalidAccessError||Error,G=f.InvalidAccessError||Error;
f.Promise||(f.Promise=function(){function a(a){return a&&null===a.oncomplete&&null===a.onerror?new c(function(c,b){a.oncomplete=function(){c(a.result)};a.onerror=function(){b(new B(a.toString()))}}):a}function c(d){function e(a){try{a()}catch(b){}}var b="pending",f,m=[],h=[];try{d(function(a){"pending"===b&&(b="fulfilled",f=a,m.forEach(e))},function(a){"pending"===b&&(b="rejected",f=a,h.forEach(e))})}catch(k){"pending"===b&&(b="rejected",f=k,h.forEach(e))}this.then=function(d,e){return new c(function(c,
k){function q(){var b;try{b=d?d(f):f}catch(e){k(e);return}(b=a(b))&&b.then&&b.then.call?b.then(c,k):c(b)}function g(){var b;try{b=e?e(f):f}catch(d){k(d);return}(b=a(b))&&b.then&&b.then.call?b.then(c,k):k(b)}"fulfilled"===b?q():"rejected"===b?g():(m.push(q),h.push(g))})};this["catch"]=function(a){return this.then(void 0,a)}}c.all=function(a){return new c(function(c,b){function f(a){q++;return function(b){h[a]=b;q--;0===q&&c(h)}}function k(a){0<q&&b(a);q=0}for(var h=[],q=0,g=0,p=a.length;g<p;g++){var l=
a[g];l.then&&l.then.call?l.then(f(g),k):h[g]=l}0===q&&c(h)})};return c}());var z="",A="";"undefined"!==typeof document&&function(){for(var a=/^(.*)gostCrypto(.*)\.js$/i,c=document.querySelectorAll("script"),d=0,e=c.length;d<e;d++){var b=c[d].getAttribute("src");if(b=a.exec(b))z=b[1],A=b[2]}}();var w,v=[],J=0;if(!f.importScripts&&!f.gostEngine)try{w=new Worker(z+"gostEngine"+A+".js"),w.onmessage=function(a){for(var c=a.data.id,d=0,e=v.length;d<e&&v[d].id!==c;d++);d<e&&(c=v[d],v.splice(d,1),a.data.error?
