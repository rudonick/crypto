...
"id-tc26-signwithdigest-gost3410-12-512":"GOST R 34.10-512/GOST R 34.11-512","id-tc26-hmac-gost-3411-12-256":"GOST R 34.11-256-HMAC","id-tc26-hmac-gost-3411-12-512":"GOST R 34.11-512-HMAC","id-tc26-agreement-gost-3410-12-256":"GOST R 34.10-256-DH/GOST R 34.11-256","id-tc26-agreement-gost-3410-12-512":"GOST R 34.10-512-DH/GOST R 34.11-512","id-sc-gost28147-ecb":"GOST 28147-89-ECB/E-SC","id-sc-gost28147-gamma":"GOST 28147-89-CNT/E-SC","id-sc-gost28147-gfb":"GOST 28147-89-CFB/E-SC","id-sc-gost28147-mac":"GOST 28147-89-MAC/E-SC",
...
digest:a["id-sc-gostR3411-94"],encryption:{id:"id-sc-gost28147-gfb",name:"GOST 28147-89-CFB/E-SC",iv:new Uint8Array([0,0,0,0,0,0,0,0])},hmac:a["id-sc-hmacWithGostR3411"],wrapping:["id-sc-cmsGostWrap"],agreement:a["id-sc-r3410-ESDH-r3411kdf"],derivation:{id:"PBKDF2",name:"GOST R 34.11-94-PBKDF2",iterations:1E3},pbes:a["id-sc-pbeWithGost3411AndGost28147CFB"]},"SC-01":{signature:a["id-sc-gostR3411-94-with-gostR3410-2001"],generation:{id:"id-sc-gostR3410-2001",name:"GOST R 34.10-2001",namedCurve:"P-256"},
digest:a["id-sc-gostR3411-94"],encryption:{id:"id-sc-gost28147-gfb",name:"GOST 28147-89-CFB/E-SC",iv:new Uint8Array([0,0,0,0,0,0,0,0])},hmac:a["id-sc-hmacWithGostR3411"],wrapping:a["id-sc-cmsGostWrap"],agreement:a["id-sc-r3410-ESDH-r3411kdf"],derivation:{id:"PBKDF2",name:"GOST R 34.11-94-PBKDF2",iterations:1E3},pbes:a["id-sc-pbeWithGost3411AndGost28147CFB"]},"RSA-1024":{signature:a.sha1withRSAEncryption,generation:{id:"rsaEncryption",name:"RSASSA-PKCS1-v1_5",modulusLength:1024,publicExponent:new Uint8Array([1,
0,1])},digest:a.sha1,encryption:a["aes128-CFB"],hmac:a.hmacWithSHA1},"RSA-2048":{signature:a.sha256withRSAEncryption,generation:{id:"rsaEncryption",name:"RSASSA-PKCS1-v1_5",modulusLength:2048,publicExponent:new Uint8Array([1,0,1])},digest:a.sha256,encryption:a["aes256-CFB"],hmac:a.hmacWithSHA256},"RSA-4096":{signature:a.sha512withRSAEncryption,generation:{id:"rsaEncryption",name:"RSASSA-PKCS1-v1_5",modulusLength:4096,publicExponent:new Uint8Array([1,0,1])},digest:a.sha512,encryption:a["aes256-CFB"],
hmac:a.hmacWithSHA512},"ECDSA-256":{signature:a["ecdsa-with-SHA256"],generation:{id:"ecdsa",name:"ECDSA",namedCurve:"P-256"},digest:a.sha256,encryption:a["aes256-CFB"],hmac:a.hmacWithSHA256,agreement:a.ecDH},"ECDSA-384":{signature:a["ecdsa-with-SHA384"],generation:{id:"ecdsa",name:"ECDSA",namedCurve:"P-384"},digest:a.sha384,encryption:a["aes256-CFB"],hmac:a.hmacWithSHA384,agreement:a.ecDH},"ECDSA-521":{signature:a["ecdsa-with-SHA512"],generation:{id:"ecdsa",name:"ECDSA",namedCurve:"P-521"},digest:a.sha512,
encryption:a["aes256-CFB"],hmac:a.hmacWithSHA512,agreement:a.ecDH}};"CP-94 CP-01 TC-256 TC-512 SC-94 SC-01".split(" ").forEach(function(a){a=b[a];a.hmac.hash=a.digest;a.derivation.hash=a.digest;a.derivation.hmac=a.hmac;a.pbes=a.pbes||{id:"PBES2",derivation:a.derivation,encryption:a.encryption};a.pbmac=a.pbmac||{id:"PBMAC1",derivation:a.derivation,hmac:a.hmac}});"RSA-1024 RSA-2048 RSA-4096 ECDSA-256 ECDSA-384 ECDSA-521".split(" ").forEach(function(a){a=b[a];a.derivation=a.derivation||{id:"PBKDF2",
name:"PBKDF2",iterations:1E3,hash:a.digest};a.pbes=a.pbes||{id:"PBES2",derivation:a.derivation,encryption:a.encryption};a.pbmac=a.pbmac||{id:"PBMAC1",derivation:a.derivation,hmac:a.hmac}});e.crypto&&e.crypto.subtle&&setTimeout(function(){e.crypto.subtle.generateKey(b["RSA-2048"].generation)["catch"](function(){b["RSA-1024"].generation.hash=b["RSA-1024"].digest;b["RSA-2048"].generation.hash=b["RSA-2048"].digest;b["RSA-4096"].generation.hash=b["RSA-4096"].digest;a.rsaEncryption.hash=b["RSA-2048"].digest})});
return{names:c,identifiers:g,algorithms:a,parameters:{"id-GostR3410-94-TestParamSet":{namedParam:"S-TEST"},"id-GostR3410-94-CryptoPro-A-ParamSet":{namedParam:"S-A"},"id-GostR3410-94-CryptoPro-B-ParamSet":{namedParam:"S-B"},"id-GostR3410-94-CryptoPro-C-ParamSet":{namedParam:"S-C"},"id-GostR3410-94-CryptoPro-D-ParamSet":{namedParam:"S-D"},"id-GostR3410-94-CryptoPro-XchA-ParamSet":{namedParam:"X-A"},"id-GostR3410-94-CryptoPro-XchB-ParamSet":{namedParam:"X-B"},"id-GostR3410-94-CryptoPro-XchC-ParamSet":{namedParam:"X-C"},
"id-GostR3410-2001-CryptoPro-TestParamSet":{namedCurve:"S-256-TEST"},"id-GostR3410-2001-CryptoPro-A-ParamSet":{namedCurve:"S-256-A"},"id-GostR3410-2001-CryptoPro-B-ParamSet":{namedCurve:"S-256-B"},"id-GostR3410-2001-CryptoPro-C-ParamSet":{namedCurve:"S-256-C"},"id-GostR3410-2001-CryptoPro-XchA-ParamSet":{namedCurve:"X-256-A"},"id-GostR3410-2001-CryptoPro-XchB-ParamSet":{namedCurve:"X-256-B"},"id-tc26-gost-3410-12-256-paramSetTest":{namedCurve:"T-256-TEST"},"id-tc26-gost-3410-12-256-paramSetA":{namedCurve:"T-256-A"},
"id-tc26-gost-3410-12-256-paramSetB":{namedCurve:"T-256-B"},"id-tc26-gost-3410-12-512-paramSetTest":{namedCurve:"T-512-TEST"},"id-tc26-gost-3410-12-512-paramSetA":{namedCurve:"T-512-A"},"id-tc26-gost-3410-12-512-paramSetB":{namedCurve:"T-512-B"},"id-tc26-gost-3410-12-512-paramSetC":{namedCurve:"T-512-C"},"id-tc26-gost-3410-12-512-paramSetD":{namedCurve:"T-512-D"},secp256r1:{namedCurve:"P-256"},secp384r:{namedCurve:"P-384"},secp521r:{namedCurve:"P-521"},"id-GostR3411-94-TestParamSet":{sBox:"D-TEST"},
"id-GostR3411-94-CryptoProParamSet":{sBox:"D-A"},"id-GostR3411-94-CryptoPro-A-ParamSet":{sBox:"D-B"},"id-GostR3411-94-CryptoPro-B-ParamSet":{sBox:"D-C"},"id-GostR3411-94-CryptoPro-C-ParamSet":{sBox:"D-D"},"id-Gost28147-89-TestParamSet":{block:"CNT",sBox:"E-TEST"},"id-Gost28147-89-CryptoPro-A-ParamSet":{block:"CFB",sBox:"E-A",keyMeshing:"CP"},"id-Gost28147-89-CryptoPro-B-ParamSet":{block:"CFB",sBox:"E-B",keyMeshing:"CP"},"id-Gost28147-89-CryptoPro-C-ParamSet":{block:"CFB",sBox:"E-C",keyMeshing:"CP"},
"id-Gost28147-89-CryptoPro-D-ParamSet":{block:"CFB",sBox:"E-D",keyMeshing:"CP"},"id-Gost28147-89-None-KeyMeshing":{keyMeshing:"NO"},"id-Gost28147-89-CryptoPro-KeyMeshing":{keyMeshing:"CP"},"id-tc26-gost-28147-param-Z":{sBox:"E-Z"}},attributes:{sBox:{"D-TEST":"id-GostR3411-94-TestParamSet","D-A":"id-GostR3411-94-CryptoProParamSet","D-B":"id-GostR3411-94-CryptoPro-A-ParamSet","D-C":"id-GostR3411-94-CryptoPro-B-ParamSet","D-D":"id-GostR3411-94-CryptoPro-C-ParamSet","E-TEST":"id-Gost28147-89-TestParamSet",
"E-A":"id-Gost28147-89-CryptoPro-A-ParamSet","E-B":"id-Gost28147-89-CryptoPro-B-ParamSet","E-C":"id-Gost28147-89-CryptoPro-C-ParamSet","E-D":"id-Gost28147-89-CryptoPro-D-ParamSet","E-Z":"id-tc26-gost-28147-param-Z","D-256":"id-tc26-gost3411-12-256","D-512":"id-tc26-gost3411-12-512"},namedParam:{"S-TEST":"id-GostR3410-94-TestParamSet","S-A":"id-GostR3410-94-CryptoPro-A-ParamSet","S-B":"id-GostR3410-94-CryptoPro-B-ParamSet","S-C":"id-GostR3410-94-CryptoPro-C-ParamSet","S-D":"id-GostR3410-94-CryptoPro-D-ParamSet",
"X-A":"id-GostR3410-94-CryptoPro-XchA-ParamSet","X-B":"id-GostR3410-94-CryptoPro-XchB-ParamSet","X-C":"id-GostR3410-94-CryptoPro-XchC-ParamSet"},namedCurve:{"S-256-TEST":"id-GostR3410-2001-CryptoPro-TestParamSet","S-256-A":"id-GostR3410-2001-CryptoPro-A-ParamSet","S-256-B":"id-GostR3410-2001-CryptoPro-B-ParamSet","S-256-C":"id-GostR3410-2001-CryptoPro-C-ParamSet","X-256-A":"id-GostR3410-2001-CryptoPro-XchA-ParamSet","X-256-B":"id-GostR3410-2001-CryptoPro-XchB-ParamSet","P-256":"secp256r1","T-256-TEST":"id-tc26-gost-3410-12-256-paramSetTest",
"T-256-A":"id-tc26-gost-3410-12-256-paramSetA","T-256-B":"id-tc26-gost-3410-12-256-paramSetB","T-512-TEST":"id-tc26-gost-3410-12-512-paramSetTest","T-512-A":"id-tc26-gost-3410-12-512-paramSetA","T-512-B":"id-tc26-gost-3410-12-512-paramSetB"}},providers:b}});
