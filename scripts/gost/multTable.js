...
var kBa = [148, 32, 133, 16, 194, 192, 1, 251, 1, 192, 194, 16, 133, 32, 148, 1];

var kB = [4, 2, 3, 1, 6, 5, 0, 7, 0, 6, 1, 3, 2, 4, 0];

// 0,  1,  2,   3,   4,   5,   6,   7
var kBx = [1, 16, 32, 133, 148, 192, 194, 251];

function printTable(s, x, k) {
    for (var i = 0; i < 256; i++)
        s[k + i] = multTable[x + i].toString(16);
}

var s = new Uint8Array(256 * 8);
