...
/-----\s?BEGIN [A-Z0-9\s]+-----([A-Za-z0-9\+\/\s\=]+)-----\s?END [A-Z0-9\s]+-----/g.exec(c));if(b)c=b[1];else throw new (t.DataError||Error)("Not valid PEM format");c=s.Base64.decode(c);q&&(c=s.BER.decode(c));return c}};return s});
